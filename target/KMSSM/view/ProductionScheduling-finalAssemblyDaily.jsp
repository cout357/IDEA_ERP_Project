			...
			<ul class="nav-list">
				...
				<li class="nav-item">
					<div class="nav-head borb">
						<div class="text-icon head-icon icon"><span class="icon-text">生</span></div>
						<span class="text">生产排程管理</span>
					</div>
					<ul class="select-list">
						
						<li class="select-item">
							<a href="view/ProductionScheduling-metalworkingDaily.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">金</span></div>
								<span class="select-text text">金工生产计划进度/日报</span>
						...
						<li class="select-item">
							<a href="view/ProductionScheduling-injectionMoldingDaily.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">注</span></div>
								<span class="select-text text">注塑生产计划进度/日报</span>
						...
						<li class="select-item">
							<a href="view/ProductionScheduling-stampingDaily.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">冲</span></div>
								<span class="select-text text">冲压生产计划进度/日报</span>
						...
						<li class="select-item">
							<a href="view/ProductionScheduling-rotorDaily.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">《</span></div>
								<span class="select-text text">《转子部装计划进度/日报》</span>
						...
						<li class="select-item">
							<a href="view/ProductionScheduling-statorDaily.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">《</span></div>
								<span class="select-text text">《定子部装计划进度/日报》</span>
						...
						<li class="select-item">
							<a href="view/ProductionScheduling-finalAssemblyDaily.jsp" class="select-a  selected">
								<div class="text-icon icon"><span class="icon-text">《</span></div>
								<span class="select-text text">《总装计划进度/日报》</span>
						...
						<li class="select-item">
							<a href="view/ProductionScheduling-process.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">《</span></div>
								<span class="select-text text">《制程工序瓶颈分析改进》</span>

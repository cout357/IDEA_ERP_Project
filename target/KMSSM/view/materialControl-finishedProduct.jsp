				...
				<li class="nav-item">
					...
					<ul class="select-list">
						...
						<li class="select-item">
							<a href="view/materialControl-finishedProduct.jsp" class="select-a  selected">
			...
			<div class="head">
				<div class="head-left">
					<ul class="head-list">
						...
						<li class="head-item tablelink">
							<a class="mainlink" href="view/materialControl-finishedProduct.jsp">物控管理</a>
							<div class="dropdown-content">
								<ul class="droplist">
                                    
									<li class="dropitem">
										<a class="droplink" href="view/materialControl-finishedProduct.jsp">成品库存标准及库存动态</a>
									</li>

...
public class QueryInfoByCustomerInfo {
	...
	public QueryInfoByCustomerInfo() {}
	public QueryInfoByCustomerInfo(Integer limitBegin,Integer pageDataCount) {
		this.limitBegin = limitBegin;
		this.pageDataCount = pageDataCount;
	}
	//将前台传来的数组数据转为mysql排序条件语句，其中前台传来的
	public QueryInfoByCustomerInfo(List<String> screenInfoPackage) {
		int flag = 0;
	...
	public QueryInfoByCustomerInfo(List<String> screenInfoPackage,int limitBegin,int pageDataCount) {

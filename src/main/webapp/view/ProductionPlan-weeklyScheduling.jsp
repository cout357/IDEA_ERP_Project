					...
					<ul class="select-list">
						...
						<li class="menu active">
							<a href="javascript:;" class="select-a  fa open">
								...
								<span class="select-text text">生产主计划周滚动排程</span>
							...
							<ul class="subsublist">
								...
								<li class="subsubitem">
									<a href="view/ProductionPlan-weeklyScheduling.jsp" class="select-a  selected">
										<div class="text-icon icon"><span class="icon-text">周</span></div>
										<span class="select-text text">周排程矩阵优化分析</span>
									</a>
								</li>
						...
						<li class="select-item">
							<a href="view/ProductionPlan-BOMAndERP.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">BO</span></div>
								<span class="select-text text">BOM库&ERP运算</span>
						...
						<li class="select-item">
							<a href="view/ProductionPlan-purchase.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">《</span></div>
								<span class="select-text text">《采购需求计划及进度》</span>
						...
						<li class="select-item">
							<a href="view/ProductionPlan-metalworking.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">《</span></div>
								<span class="select-text text">《金工生产计划排程》</span>
						...
						<li class="select-item">
							<a href="view/ProductionPlan-injectionMolding.jsp" class="select-a ">
								<div class="text-icon icon"><span class="icon-text">《</span></div>
								<span class="select-text text">《注塑生产计划排程》</span>

					...
					<div class="table-box" id="data-table-box">
						...
						<table class="datatable long">
							...
							<c:forEach items="${ordersAndJournals }" var="oaj" varStatus="idx">
								<tr class="row hidTrs">
									<th class="hor"><input type="checkbox" checked class="dataCheb" value="${oaj.oaj_id }" /></th>
...
<!-- 导入数据的选择文件-对话框 -->
	    <div class="import-chooseFileBox dialog" >
		...
		<script charset="UTF-8" type="text/javascript">
			...
			function refreshPrintingDataSuc(hash){
				...
				for(var i = 0;i < datas.length;i++){
					...
					$vals.eq(1).text(datas[i].month);
					$vals.eq(2).text(datas[i].orderDate);
					$vals.eq(3).text(datas[i].orderId);
					$vals.eq(4).text(datas[i].salesMan);
					$vals.eq(5).text(datas[i].oeId);
					$vals.eq(6).text(datas[i].kmId);
					$vals.eq(7).text(datas[i].cusLevel);
					$vals.eq(8).text(datas[i].cusName);
					$vals.eq(9).text(datas[i].orderDemand);
					$vals.eq(10).text(datas[i].req);
					$vals.eq(11).text(datas[i].deliveryDate);
					$vals.eq(12).text(datas[i].countdown);
					$vals.eq(13).text(datas[i].storageQT);
					$vals.eq(14).text(datas[i].deliveryQT);
					$vals.eq(15).text(datas[i].preDate);
					$vals.eq(16).text(datas[i].inventory);
					$vals.eq(17).text(datas[i].availableQT);
					$vals.eq(18).text(datas[i].orderMatchingNum);
					$vals.eq(19).text(datas[i].underCount);
					$vals.eq(20).text(datas[i].dyLoc);
					$vals.eq(21).text(datas[i].box);
					$vals.eq(22).text(datas[i].boxNum);
					$vals.eq(23).text(datas[i].remarks);
